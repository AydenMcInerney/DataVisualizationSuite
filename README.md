...
3. Open the desired application folder.

4. Launch the corresponding HTML file in your browser.

5. Ensure you have an internet connection, as each application retrieves live data from external APIs.
...
* Historical weather tracking
* Enhanced country statistics and charts
* Additional cryptocurrency analytics
* Favorites and bookmarking functionality
* Mobile optimization
* Dark mode support
...
5. Open the application in your browser and explore the dashboards.
